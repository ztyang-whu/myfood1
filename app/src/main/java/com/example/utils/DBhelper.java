...
public class DBhelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		// 下面个表是系统设置,提前设置ip地址
		db.execSQL("CREATE TABLE [system] ([id] INTEGER  PRIMARY KEY AUTOINCREMENT NOT NULL,[address] VARCHAR(500) NULL)");
		db.execSQL("insert into [system] (address) values('default')");
		db.execSQL("CREATE TABLE [basket] ([id] INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, [userid] VERCHAR(20) NULL,[foodname] VERCHAR(20) NULL, [storename] VARCHAR(20) NULL, [foodcount] INTEGER NULL, [expense] VERCHAR(20) NULL)");
	}
