...
public class jsonMenu {
    public static List<FoodBean> getJsonFoods(String IP, String storeName){
        HttpURLConnection conn = null;
        InputStream is = null;
        try {
            String path = "http://" + IP + "/test/storeFoodServlet";
            path = path + "?storeName=" + storeName;
    ...
    private static List<FoodBean> parsejson(InputStream inputStream) throws Exception {
        ...
        JSONArray jsonArray=jsonObject.getJSONArray("storeFood");
