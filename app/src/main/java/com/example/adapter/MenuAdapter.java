...
import com.example.myfood.MenuActivity;
...
public class MenuAdapter extends BaseAdapter {
    ...
    public MenuAdapter(MenuActivity context, List<FoodBean> list){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        try{
            if(convertView==null){
                convertView=layoutInflater.from(context).inflate(R.layout.item_diancai,null);
                viewHolder=new ViewHolder();
                viewHolder.caipin_food_image=(ImageView) convertView.findViewById(R.id.diancai_food_image);
                viewHolder.food_storename=(TextView) convertView.findViewById(R.id.diancai_shangjianame_text);
                viewHolder.food_name=(TextView) convertView.findViewById(R.id.diancai_foodname_text);
                viewHolder.food_count=(TextView) convertView.findViewById(R.id.diancai_xiaoliang_text);
